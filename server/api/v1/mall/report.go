...
var reportService = service.ServiceGroupApp.MallServiceGroup.ReportService
...
// @accept application/json
// @Produce application/json
// @Param data body mall.Report true "删除Report"
...
// @accept application/json
// @Produce application/json
// @Param data body mall.Report true "更新Report"
...
// @accept application/json
// @Produce application/json
// @Param data query mall.Report true "用id查询Report"
...
// @accept application/json
// @Produce application/json
// @Param data query mallReq.ReportSearch true "分页获取Report列表"
// @Success 200 {string} string "{"success":true,"data":{},"msg":"获取成功"}"
// @Router /report/getReportList [get]
func (reportApi *ReportApi) GetReportList(c *gin.Context) {
	var pageInfo mallReq.ReportSearch
