...
var categoryService = service.ServiceGroupApp.MallServiceGroup.CategoryService
...
// @accept application/json
// @Produce application/json
// @Param data body mall.Category true "删除Category"
...
// @accept application/json
// @Produce application/json
// @Param data body mall.Category true "更新Category"
...
// @accept application/json
// @Produce application/json
// @Param data query mall.Category true "用id查询Category"
...
// @accept application/json
// @Produce application/json
// @Param data query mallReq.CategorySearch true "分页获取Category列表"
// @Success 200 {string} string "{"success":true,"data":{},"msg":"获取成功"}"
// @Router /category/getCategoryList [get]
func (categoryApi *CategoryApi) GetCategoryList(c *gin.Context) {
	var pageInfo mallReq.CategorySearch
