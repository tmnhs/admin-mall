...
import (
	...
	//"github.com/tmnhs/admin-mall/server/plugin/email" // 本地插件仓库地址模式
	"github.com/tmnhs/admin-mall/server/plugin/example_plugin"
	"github.com/tmnhs/admin-mall/server/utils/plugin"
