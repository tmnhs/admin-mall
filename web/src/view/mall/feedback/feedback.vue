  ...
  <div>
    <div class="gva-search-box">
      <el-form :inline="true" :model="searchInfo" class="demo-form-inline">
            <el-form-item label="是否已阅" prop="status">
    ...
    <div class="gva-table-box">
        ...
        <el-table-column align="left" label="反馈内容" prop="content" width="120" />
        <el-table-column align="left" label="是否已阅" prop="status" width="120">
                 <template #default="scope">
                      <el-switch v-model="scope.row.status" active-color="#13ce66" inactive-color="#ff4949"  clearable disabled></el-switch>
                  </template>
        </el-table-column>
             <el-table-column align="left" label="反馈时间" prop="createdTime" width="200" >
            <template #default="scope">{{ formatUnixDate(scope.row.createdTime) }}</template>
        </el-table-column>
        <el-table-column align="left" label="按钮组">
            <template #default="scope">
            <el-button type="text" icon="edit" size="small" class="table-button" @click="updateFeedbackFunc(scope.row)">变更</el-button>
